...
<head>
    ...
    <title>Quiz Attempt Submitted</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Quiz Attempt Submitted</h1>
        </div>
        <div class="content">
            <div class="greeting">Hello {{ $instructorName }},</div>
            <div class="intro">A student has completed the quiz <strong>{{ $quizTitle }}</strong> in course <strong>{{ $courseTitle }}</strong>. Details are below:</div>
            ...
            <div class="details-card">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value"><strong>{{ $score }}%</strong></div>
                </div>
                <div class="detail-row">
            ...
            <div class="button-container">
                <a href="{{ $actionUrl }}" class="button" target="_blank">View Course Report</a>
            </div>
        </div>
        <div class="footer">
